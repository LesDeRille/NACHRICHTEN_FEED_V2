...
#
### tagesschau_2025_08_28_V02

#### Basis: tagesschau_2025_08_28_V01

#### Änderung:
* oncontextmenu dorch onclick ersetzt, damit man auch auf Touchscreens die Blacklist bearbeiten kann
...
#
### tagesschau_2025_08_28_V01

#### Basis: tagesschau_2025_08_27_V02

#### Änderung:
* Lesen aus localStorage mit try-catch abgesichert. In der function weiterImPrivatenModus werden Defaults für "Ressortaufrufe" und "Blacklist" erstellt.
...
#
### tagesschau_2025_08_27_V02

#### Basis: tagesschau_2025_08_27_V01

#### Änderung:
* Lesen aus localStorage mit try-catch abgesichert
...
#
### tagesschau_2025_08_27_V01

#### Basis: tagesschau_2025_08_26_V03

#### Änderung:
* Wenn blacklist nicht auf localStorage steht, wird ein Default [] gesetzt
...
#
### tagesschau_2025_08_26_V03

#### Basis: tagesschau_2025_08_26_V02

#### Änderung:
* gewaehltesRessort und defaultRessort zusammengafaßt
...
#### Änderung:
* 2px margin zwischen den Tag-Buttons
...
#
### tagesschau_2025_08_25_V02

#### Basis: tagesschau_2025_08_25_V01

#### Änderung:
* Zeile "angezeigtes Ressort" rausgenommen. Ist durch Hervorheben des angeklickten Ressorts erkennbar
* Ressort Sport in der Liste der wählbaren Ressorts schon beim Programmstart groß gemacht
...
#
### tagesschau_2025_08_25_V01

#### Basis: tagesschau_2025_08_24_V01

#### Änderung:
* Für alle Buttons eine eigene class gesetzt. Damit kann ich jeden Buttontyp gezielt stylen

#### ToDo:
* Ressort Sport in der Liste der wählbaren Ressorts schon beim Programmstart groß machen
* Zeile 'Angezeigtes Ressort' kann raus
* Speicherung des letzten Ressortaufrufs scheint nicht mehr zu funktionieren
* Optisch aufbereiten
* gelesene markieren
* Refresh-Knopf (oder einfach neu laden?)
...
#
### tagesschau_2025_08_24_V01

#### Basis: tagesschau_2025_08_23_V01

#### Änderung:
* Ressortbutton wird duch Klick größer. Die anderen springen wieder in Ihre Ausgangsgröße zurück
...
#
### tagesschau_2025_08_23_V01

#### Basis: tagesschau_2025_08_22_V05

#### Änderung:
* Ressortbutton wird duch Klick größer. 
...
#
### tagesschau_2025_08_22_V05

#### Basis: tagesschau_2025_08_22_V04

#### Änderung:
* Aufgeräumt

#### ToDo:
* Es wäre schöner, statt einer eigenen Zeile, das gewählte Ressort hervorzuheben. Würde Platz sparen und wäre übersichtlicher
* Speicherung des letzten Ressortaufrufs scheint nicht mehr zu funktionieren
* Optisch aufbereiten
* gelesene markieren
* Refresh-Knopf (oder einfach neu laden?)
...
#
### tagesschau_2025_08_22_V04

#### Basis: tagesschau_2025_08_22_V03

#### Änderung:
* Ressortbuttons größer
...
#
### tagesschau_2025_08_22_V01

#### Basis: tagesschau_2025_08_20_V04

#### Änderung:
* Blacklist wird jetzt korrekt ausgegeben. Es fehlt aber noch der Titel "Blockierte Schlagworte'. Der war auch ein Children, deswegen ist der jetzt weg
...
#
### tagesschau_2025_08_20_V04

#### Basis: tagesschau_2025_08_20_V03

#### Änderung:
* Begonnen, klappt aber nicht: Bei der Behandlung der Rechtsklicks klappt die neue Optik noch nicht
...
#
### tagesschau_2025_08_20_V03

#### Basis: tagesschau_2025_08_20_V02

#### Änderung:
* Aufgehübschte Überschriften
...
#
### tagesschau_2025_08_20_V02

#### Basis: tagesschau_2025_08_20_V01

#### Änderung:
* Beim Durchklicken der Ressorts stimmt es aber noch nicht. Ich verstehe das Startressort aktuell nicht
...
#### Änderung:
* Begonnen, die Überschriften schöner zu machen. Bis jetzt nur Dummys drin, gelb oder rot hinterlegte Überschriften. Damit ich sehe, wie man auf eine Überschriftenklasse zugreift. Siehe auch https://developer.mozilla.org/de/docs/Web/API/Document/getElementsByClassName
    * siehe dazu das keynote NachrichtentickerLayout.key
...
#
### tagesschau_2025_08_19_V04

#### Basis: tagesschau_2025_08_19_V03

#### Änderung:
* function machButtonAusTag erledigt jetzt alle TagButton Erzeugungen. DRY damit besser berücksichtigt
...
#
### tagesschau_2025_08_19_V03

#### Basis: tagesschau_2025_08_19_V02

#### Änderung:
* ueberholte Blacklist und Ressortaufrufe aus localStorage gelöscht (außerhalb des Programms erledigt)
* DRY
    * Übergeben muß ich das Array aller zu verwaltenden Tags --> ok
    * die tagButton-Variable --> erledigt
    * die tagDialog-Variable --> erledigt
    * die neuerTitel-Variable --> erledigt
...
#
### tagesschau_2025_08_19_V02

#### Basis: tagesschau_2025_08_19_V01

#### Änderung:
* ueberholte Blacklist und Ressortaufrufe aus localStorage gelöscht (außerhalb des Programms erledigt)
* DRY
    * Übergeben muß ich das Array aller zu verwaltenden Tags --> ok
    * die tagButton-Variable
    * die tagDialog-Variable --> erledigt
    * die neuerTitel-Variable --> erledigt
Hier die Problembeschreibung
* für meldung als Button ausgeben gibt es jetzt eine function machButtonAusTag. Es steht aber auch noch einmal extra im Quelltext, das muß ich zusammenfassen wegen DRY
...
#
### tagesschau_2025_08_19_V01

#### Basis: tagesschau_2025_08_18_V06
...
#
### tagesschau_2025_08_18_V06

#### Basis: tagesschau_2025_08_18_V05

#### Änderung:
* alle getItems und setItems aktualisiert
...
* für meldung als Button ausgeben gibt es jetzt eine function machButtonAusTag. Es steht aber auch noch einmal extra im Quelltext, das muß ich zusammenfassen wegen DRY
* Handling prüfen. Manchmal wechselt er des Ressort, wenn man die Tags ändert
* ueberholte Blacklist und Ressortaufrufe aus localStorage löschen


#
### tagesschau_2025_08_18_V05

#### Basis: tagesschau_2025_08_18_V04
...
#
### tagesschau_2025_08_18_V04

#### Basis: tagesschau_2025_08_18_V03

#### Änderung:
* Tag zu Blacklist hinzufügen und entfernen wird in localStorage übernommen
